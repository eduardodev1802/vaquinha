...
export class HistoricoComponent implements OnInit {
  ...
  constructor(private matDialog: MatDialog, private location: Location, private dbFirestore: AngularFirestore, private router: Router, private projetoService: ProjetoService) { }
